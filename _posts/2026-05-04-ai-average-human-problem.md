...
So the "AI flavour" critics detect is not imagined but it isn't fake humanness either. It's averaged humanness. Which is a more interesting target than "AI sounds unnatural," because it explains why the false-positive pattern lands where it does.
...
If you write for a living, or think for a living, the loud version of this matters less than the discourse around it suggests. The inverse of the accusation is nearer the mark: the patterns flagged as machine-generated are the patterns of the most common kind of human writing. AI didn't invent them — it learned them from us.
