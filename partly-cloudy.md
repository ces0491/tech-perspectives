...
That shift is easy to miss under the louder noise about AI, but it matters at least as much. The cloud has come apart into components, and the consequence isn't only technical. It changes what the central question even is. For a long time the question was *can we run this at all?* Now it's *which of dozens of viable options do we pick, and what does it cost us to keep them talking to each other?*
...
Most of that argument has been written as though the choice were borderless. From where we sit, it isn't. Geography reasserts itself the moment you take residency, latency, and regulation seriously — and in South Africa it reasserts itself.

The hyperscalers have spent real money locally. AWS opened its Cape Town region in 2020, Microsoft runs regions in both Johannesburg and Cape Town, and Google opened Johannesburg in 2024. That means in-country data residency and low latency from a generalist you can also buy everything else from. Most of the new specialists offer nothing of the sort: the GPU neoclouds and platforms like Modal run from data centres abroad, with no African region at all. A few are exceptions — Cloudflare has edge presence in Johannesburg, Cape Town, and Durban — but the typical specialist sits across an ocean. Using one from here means accepting the latency and, more consequentially, sending your data offshore.

That last part is where the trade-off stops being academic. POPIA doesn't demand blanket localisation, but it restricts moving personal information out of the country without adequate protection in place, and the regulators who watch finance and insurance lean hard toward keeping customer data close to home. For a regulated client, a specialist with no African region isn't merely slower — it's a compliance conversation, with penalties that run to millions of rands. Layer on the currency exposure of paying for a USD-billed service in rands, and the marginal performance edge that made the specialist attractive can quietly be eaten alive by everything attached to it.
